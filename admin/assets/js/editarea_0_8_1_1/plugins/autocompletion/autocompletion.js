/**
 * @version $Id: autocompletion.js 5 2010-11-05 20:59:12Z elkuku $
	...
	,get_control_html: function(ctrl_name){
		switch( ctrl_name ){
			case 'autocompletion':
				...
				return parent.editAreaLoader.get_button_html('autocompletion_but', 'charmap.gif', 'toggle_autocompletion', false, this.baseURL);
				break;
		}
		return false;
	}
