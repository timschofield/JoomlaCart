/**
 * @version $Id: autocompletion.js 245 2010-12-10 07:54:28Z elkuku $
						...
						for( var prefix in datas["KEYWORDS"] )
						{
							...
							for( var j=0; j<datas["KEYWORDS"][prefix].length; j++ )
							{
								tmp["keywords"][prefix]['datas'][j]= {
									...
									replace_with: datas["KEYWORDS"][prefix][j][1] ? datas["KEYWORDS"][prefix][j][1].replace('x', datas["KEYWORDS"][prefix][j][0] ) : '',
