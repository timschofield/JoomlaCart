/**
 * @version $Id: php_file_tree.js 5 2010-11-05 20:59:12Z elkuku $
 ...
 * 
 * Modified by Cory S.N. LaViska http://abeautifulsite.net/
 *  == WHAT IT DOES ==
 * 
 ...
 *  == USAGE ==
 * 
 * Include the script into the <head></head> section of the appropriate page(s)
 * as shown below:
 * 
 * <script src="php_file_tree.js" type="text/javascript"></script>
 * 
 * All file trees generated by PHP File Tree will automatically collapse to the
 * top level (as specified by $directory) and become dynamic.
 *  == FAQS ==
 * 
 * Q Can I have more than one file tree on one page? A Yes. You can have as many
 * as you want and they will all function as expected.
 * 
 */
